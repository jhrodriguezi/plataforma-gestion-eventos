...
export class UpdateEventDTO implements SharedDTO<UpdateEventDTO> {
	private constructor(
	...
	public validate(dto: UpdateEventDTO): void {
	...
	public static create(object: Record<string, unknown>): UpdateEventDTO {
		const { id, user_id, location_id, name, date_time, status, description, capacity } = object;
